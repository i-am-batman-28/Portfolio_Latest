...
const CodeRain = () => {
  ...
  useEffect(() => {
    ...
    const chars = "01アイウエオカキクケコサシスセソタチツテト<>{}[]()=>∑∏∆λφπ";
    ...
    const draw = () => {
      ...
      for (let i = 0; i < drops.length; i++) {
        ...
        // Head char — bright
        ctx.fillStyle = `rgba(96, 165, 250, ${Math.random() * 0.6 + 0.4})`;
        ctx.font = `${FONT_SIZE}px 'JetBrains Mono', monospace`;
        ctx.fillText(char, i * FONT_SIZE, y);

        // Fade trail handled by overlay above
  ...
  return (
    <canvas
      ref={canvasRef}
      style={{ width: "100%", height: "100%", display: "block", opacity: 0.35 }}
    />
  );
};
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: "0 25px 60px rgba(0,0,0,0.6), 0 0 0 1px hsl(224 15% 16%), 0 0 80px rgba(96,165,250,0.06)",
    ...
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden" style={{ zIndex: 1 }}>
        <div style={{
          ...
          background: "linear-gradient(90deg, transparent 0%, rgba(96,165,250,0.15) 30%, rgba(129,140,248,0.25) 50%, rgba(96,165,250,0.15) 70%, transparent 100%)",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-16 xl:gap-24 items-center">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mb-5"
              ...
              <div className="relative">
                <img src="/karthik.jpg" alt="Karthik M Sarma" className="w-12 h-12 rounded-full object-cover"
                  style={{ border: "2px solid hsl(217 91% 60% / 0.5)", boxShadow: "0 0 0 4px hsl(217 91% 60% / 0.1), 0 0 20px hsl(217 91% 60% / 0.2)" }} />
            ...
            >
              <span style={{
                ...
                transform: glitch ? "translate(1.5px, 0)" : "none",
                textShadow: glitch ? "1.5px 0 rgba(96,165,250,0.6)" : "none",
                transition: glitch ? "none" : "transform 0.15s, text-shadow 0.15s",
              }}>
                I build systems
              </span>
              <br />
            ...
            <div className="flex flex-wrap items-center gap-3 mb-10"
              ...
              <a href="#projects"
                ...
                style={{ background: "hsl(var(--primary))", color: "#0f172a", boxShadow: "0 0 30px hsl(217 91% 60% / 0.35), 0 4px 15px rgba(0,0,0,0.3)" }}
                onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 0 45px hsl(217 91% 60% / 0.6), 0 8px 25px rgba(0,0,0,0.3)"; }}
            ...
            <div className="flex items-center gap-5"
              style={{ opacity: loaded ? 1 : 0, transition: "opacity 0.7s ease 0.65s" }}>
              {[
          ...
          <div className="hidden lg:flex flex-col gap-4"
            ...
            <div className="grid grid-cols-3 gap-2.5">
              {[
                ...
                <div key={l} className="rounded-xl p-3.5 text-center transition-all duration-200"
                  ...
                  onMouseEnter={e => { e.currentTarget.style.borderColor = "hsl(217 91% 60% / 0.3)"; e.currentTarget.style.transform = "translateY(-2px)"; }}
                  ...
                  <p className="text-[0.62rem]"
                    style={{ color: "hsl(215 12% 38%)", fontFamily: "'JetBrains Mono', monospace" }}>{l}</p>
                </div>
              ))}
            </div>
            ...
            <div className="rounded-xl overflow-hidden"
              style={{ height: "120px", background: "hsl(224 20% 3%)", border: "1px solid hsl(224 15% 14%)", position: "relative" }}>
              <CodeRain />
              {/* fade overlay */}
              <div style={{
                position: "absolute", inset: 0,
                background: "linear-gradient(to bottom, hsl(224 20% 3%) 0%, transparent 25%, transparent 75%, hsl(224 20% 3%) 100%)",
                pointerEvents: "none",
              }} />
              <div style={{
                position: "absolute", bottom: "10px", right: "12px",
                fontFamily: "'JetBrains Mono', monospace", fontSize: "0.6rem",
                color: "rgba(96,165,250,0.4)", letterSpacing: "0.1em",
              }}>
                SYSTEM ACTIVE
              </div>
            </div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2" style={{ opacity: 0.3 }}>
        ...
        <span className="text-[0.58rem] tracking-[0.22em]"
